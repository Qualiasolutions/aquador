      ...
      <div className="container-wide section-sm">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
            ...
            <ul className="space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-black/70 hover:text-black transition-colors text-xs"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-black/70 text-xs">
              ...
              <li>
                <a
                  href="tel:99980809"
                  className="flex items-center gap-3 text-black/70 hover:text-black transition-colors text-xs"
                >
